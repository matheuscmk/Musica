...
await curAudio.playAsync();
    ...
    return(
        ...
        <TouchableOpacity onPress={()=>handleBack()} style={{marginRight:20,marginLeft:20}}>
            <AntDesign name="banckward" size={35} color="silver"></AntDesign>
        </TouchableOpacity>
{
        (!props.playing)?
        <TouchableOpacity onPress={()=>handlePlay()} style={{marginRight:20,marginLeft:20}}>
            <AntDesign name="playcircleo" size={35} color="silver"></AntDesign>
        </TouchableOpacity>
        :
        <TouchableOpacity onPress={()=>handlePause()} style={{marginRight:20,marginLeft:20}}>
        <AntDesign name="pausecircleo" size={35} color="silver"></AntDesign>
    </TouchableOpacity>
}
        <TouchableOpacity onPress={()=>handleNext()} style={{marginRight:20,marginLeft:20}}>
            <AntDesign name="forward" size={35} color="silver"></AntDesign>
        </TouchableOpacity>
        </View>
    );
}
